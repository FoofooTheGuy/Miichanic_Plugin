...
namespace CTRPluginFramework
{
	...
	std::vector<std::string> KORmegOpt{
		"Change name...",
		"Change creator...",
		"Toggle gender",
	...
	std::vector<std::string> KORableOpt{
		"Enable",
		"Disable",
	};

	std::vector<std::string> KORgenOpt{
		"Male",
		"Female",
	};
	
	std::vector<std::string> KORdelOpt{
		"No",
		"Yes",
	};
	
	std::vector<std::string> KORcolOpt{
		"\uE017 Red \uE017",
		"\uE017 Orange \uE017",
		"\uE017 Yellow \uE017",
		"\uE017 Lime \uE017",
	...
	{
		std::vector<std::string> KORcolorOpt;
		static int KORColChoice = 0;
		std::string name;
		std::string create;
		std::string finame;
		u32 pers;
		...
		if (*(u32 *)0x8032218 != 0xFFFFFFFF && (*(u16 *)0x88014D5 == 0))
		{
			...
			Sleep(Milliseconds(100));
			{
				...
				if(naop == -1)
				return;
				Process::Read16((0x5C * val) + 0x1488B7D6, fix);
				for(int i = 0; i < 10; i++) {
				   Process::Write8((0x5C * val) + (0x1488B7A0 + 0x22) + (i * 0x2), 0);
				}
				Process::WriteString((0x5C * val) + (0x1488B7A0 + 0x22), name, StringFormat::Utf16);
				if (Process::ReadString((0x5C * val) + (0x1488B7A0 + 0x22), finame, 20, StringFormat::Utf16)) {
				...
				if (IndexVec.size())
				{
					...
					Process::WriteString((0x5C * val) + (0x1488B7A0 + 0x22), finame, StringFormat::Utf16);
					Sleep(Milliseconds(100));
					MessageBox("Invalid characters detected (%), fixed.")();
				}
				}
				...
				Sleep(Milliseconds(100));
				Process::Write16((0x5C * val) + 0x1488B7D6, fix);
			...
			Sleep(Milliseconds(100));
			{
				...
				if(crop == -1)
				return;
				Process::Read16((0x5C * val) + 0x1488B804, fix);
				for(int i = 0; i < 10; i++) {
				   Process::Write8((0x5C * val) + (0x1488B7A0 + 0x50) + (i * 0x2), 0);
				}
				Process::WriteString((0x5C * val) + (0x1488B7A0 + 0x50), create, StringFormat::Utf16);
				if (Process::ReadString((0x5C * val) + (0x1488B7A0 + 0x50), finame, 20, StringFormat::Utf16)) {
				if (strstr(finame.c_str(), "%")) {
				std::string toSearch("%");
				std::vector<size_t> IndexVec = GetSubstrIndexList(finame, toSearch);
				if (IndexVec.size())
				{
					...
					Process::WriteString((0x5C * val) + (0x1488B7A0 + 0x50), finame, StringFormat::Utf16);
					Sleep(Milliseconds(100));
					MessageBox("Invalid characters detected (%), fixed.")();
				}
				}
				...
				Sleep(Milliseconds(100));
				Process::Write16((0x5C * val) + 0x1488B804, fix);
			...
			Sleep(Milliseconds(100));
					...
					case 0:
						...
						Process::Read8((0x5C * val) + (0x1488B7C0), gen);
						Process::Write8((0x5C * val) + (0x1488B7C0), (gen - 1));
			...
			KORcolorOpt.push_back(Color(Miiblack) << KORcolOpt[11]);
					...
					if (KORColChoice != -1)
					{
						std::string picked = colorcolor(KORColChoice);
						if (Process::Read8((0x17200 * val) + (0x8831D70), check) && check == KORColChoice)//if its already the color you pick
						{
						Sleep(Milliseconds(100));
						...
						else
						{
							...
							Process::Write16((0x5C * val) + (0x1488B7C0), 0);//clear space
							if(gen == 0x1) {
								Process::Read8((0x5C * val) + (0x1488B7C0), gen);
								Process::Write8((0x5C * val) + (0x1488B7C0), (gen + 1));
								Process::Write8((0x17200 * val) + (0x8831D64), 1);
							}
							Process::Read8((0x5C * val) + (0x1488B7C1), color);
							Process::Write8((0x5C * val) + (0x1488B7C1), color + (4 * KORColChoice));//write color value
							Process::Read8((0x5C * val) + (0x1488B7C1), fav);
							Process::Write8((0x5C * val) + (0x1488B7C1), (fav + 0x40));//make it favorite again
							}
							else if(check == 0) {//if its not favorite
								Process::Read8((0x17200 * val) + (0x8831D64), gen);
								Process::Write16((0x5C * val) + (0x1488B7C0), 0);
								if(gen == 0x1) {
									Process::Read8((0x5C * val) + (0x1488B7C0), gen);
									Process::Write8((0x5C * val) + (0x1488B7C0), (gen + 1));
									Process::Write8((0x17200 * val) + (0x8831D64), 1);
								...
								Process::Read8((0x5C * val) + (0x1488B7C1), color);
								Process::Write8((0x5C * val) + (0x1488B7C1), color + (4 * KORColChoice));//just make it the color
							}
							Process::Write8((0x17200 * val) + (0x8831D70), KORColChoice);//adjust internal
							Sleep(Milliseconds(100));
			...
			Sleep(Milliseconds(100));
				...
				case 0:
					...
					{
					Process::Read8((0x5C * val) + (0x1488B7C1), fav);
					Process::Write8((0x5C * val) + (0x1488B7C1), (fav + 0x40));
			...
			case 5://share done
				...
				switch (KORoptKb->Open())
				{
					case 0:
						...
						{
							Process::Read8((0x5C * val) + 0x1488B7D8, share);
							Process::Write8((0x5C * val) + 0x1488B7D8, share - 1);
							Process::Write8((0x17200 * val) + 0x8831D77, 0);
							WriteNibble((0x5C * val) + 0x1488B7B4, 9, false);
							Sleep(Milliseconds(100));
			...
			case 6://copy done
				...
				switch (KORoptKb->Open())
				{
					case 0:
						...
						{
							Process::Read8((0x5C * val) + 0x1488B7A9, copy);
							Process::Write8((0x5C * val) + 0x1488B7A9, copy + 1);
				...
				switch (KORoptKb->Open())
				{
					case 0:
						if (Process::Read8((0x17200 * val) + (0x8831D77), check) && check == 0)
						{
							...
							Process::Write8((0x5C * val) + 0x1488B7D8, share + 1);
							Process::Write8((0x17200 * val) + 0x8831D77, 0x1);
							WriteNibble((0x5C * val) + 0x1488B7B4, 1, false);
							Sleep(Milliseconds(100));
			...
			case 8://own done
			{
				for (int i = 0; i < 8; i+=4)
				{
					if (Process::Read32(0x1488B7AC + i, sysID))
					{
						Process::Write32((0x5C * val) + (0x1488B7AC + i), sysID);
					}
				}
				Sleep(Milliseconds(100));
				if(Process::ReadString((0x5C * val) + (0x1488B7A0 + 0x22), finame, 20, StringFormat::Utf16)) {
			...
			case 9:
			{
				...
				{
					if(Process::Read32((0x5C * val) + (0x1488B7A8 + i), reg))
					{
						Process::Read32((0x1488B7A8 + i), pers);
						Process::Write32((0x1488B7A8 + i), reg);
						Process::Write32((0x5C * val) + (0x1488B7A8 + i), pers);
					}
				}
				Sleep(Milliseconds(100));
			...
			{
				Sleep(Milliseconds(100));
				KORdeloptKb->Populate(KORdelOpt);
				switch (KORdeloptKb->Open())
				{
					case 0:
						return;
						break;
					case 1:
						if(val == 0)
						{
							...
							else
							{
								...
								for (int i = 0; i < 92; i+=4)
								{
								Process::Write32((0x5C * val) + (0x1488B7A8 + i), 0);
								}
								Sleep(Milliseconds(100));
